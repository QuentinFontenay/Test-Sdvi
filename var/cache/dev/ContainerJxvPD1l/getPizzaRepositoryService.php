...
// Returns the private 'App\Repository\PizzaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PizzaRepository.php';

return $this->privates['App\\Repository\\PizzaRepository'] = new \App\Repository\PizzaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
