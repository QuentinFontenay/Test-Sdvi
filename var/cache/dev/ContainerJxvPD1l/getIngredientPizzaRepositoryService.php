...
// Returns the private 'App\Repository\IngredientPizzaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/IngredientPizzaRepository.php';

return $this->privates['App\\Repository\\IngredientPizzaRepository'] = new \App\Repository\IngredientPizzaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
