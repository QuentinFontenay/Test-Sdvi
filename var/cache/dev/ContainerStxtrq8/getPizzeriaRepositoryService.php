...
// Returns the private 'App\Repository\PizzeriaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PizzeriaRepository.php';

return $this->privates['App\\Repository\\PizzeriaRepository'] = new \App\Repository\PizzeriaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
