...
// Returns the private 'App\Repository\PizzaioloRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PizzaioloRepository.php';

return $this->privates['App\\Repository\\PizzaioloRepository'] = new \App\Repository\PizzaioloRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
